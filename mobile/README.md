...
Current MVP excludes offline outbox/cache, push notifications, biometric login, AI Chat mobile screen, Contacts/CRM mobile screen, Search/Files/Analytics mobile screens, crash reporting, and store signing.
